...
function Planet() {
  ...
  // If planet is just discovered get info from API and create action
  useEffect(function() {
    if (missing) {
  ...
  // Create action for each film the planet appears in
  ...
  // Create action for each person residing on the planet
